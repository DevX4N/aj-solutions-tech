...
export const services = [
  {
    id: 'landing',
    name: 'Landing Pages',
    body: 'Páginas focadas em conversão, criadas para transformar visitantes em oportunidades de negócio.',
    meta: 'CONVERSÃO',
  },
  {
    id: 'institucional',
    name: 'Sites Institucionais',
    body: 'Sites profissionais que apresentam sua empresa, aumentam sua autoridade e passam confiança para novos clientes.',
    meta: 'PRESENÇA',
  },
  {
    id: 'servicos',
    name: 'Sites para Prestadores de Serviço',
    body: 'Estruturas digitais pensadas para gerar confiança, apresentar seus serviços e facilitar novos contatos.',
    meta: 'CREDIBILIDADE',
  },
  {
    id: 'redesign',
    name: 'Redesign de Sites',
    body: 'Modernização de sites antigos com novo visual, melhor experiência e mais performance.',
    meta: 'EVOLUÇÃO',
  },
  {
    id: 'uiux',
    name: 'UX/UI Design',
    body: 'Interfaces planejadas para oferecer clareza, facilidade de uso e uma experiência digital memorável.',
    meta: 'EXPERIÊNCIA',
  },
  {
    id: 'manutencao',
    name: 'Manutenção e Evolução',
    body: 'Melhorias contínuas, novas funcionalidades e evolução do projeto após o lançamento.',
    meta: 'CONTINUIDADE',
  },
]
...
export const projects = [
  ...
  },
  {
    ...
    year: '2026',
    tags: ['Autoridade', 'Dados em tempo real'],
    status: 'Publicado',
    accent: '#5B8CFF',
